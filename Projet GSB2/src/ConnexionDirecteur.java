...
/**
 * Classe ConnexionDirecteur
 * @author ldatchi
 *
 */
public class ConnexionDirecteur extends JFrame implements ActionListener{
	
	/**
	 * Attributs privés de la classe ConnexionDirecteur
	 */
	//Attributs privés
	//Panel
	private JPanel panelConnexionDirecteur;
	...
	public ConnexionDirecteur() {
	    ...
	    /**
	     * Instanciation de mes panels "panelConnexionDirecteur", "panelMessageAccueil", "panelChamps" et "panelBouton"
	     */
	    //Instanciation des panels
	    this.panelConnexionDirecteur = new JPanel();
	    this.panelMessageAccueil = new JPanel();
	    this.panelChamps = new JPanel();
	    this.panelBouton = new JPanel();
	    
	    /**
	     * Mise en place des background des panels "panelConnexionDirecteur", "panelMessageAccueil" et "panelBouton"
	     */
	    //Disposition des panels
	    this.panelConnexionDirecteur.setLayout(new BorderLayout());
	    ...
	    this.panelConnexionDirecteur.add(panelMessageAccueil, BorderLayout.PAGE_START);
	    this.panelMessageAccueil.add(lblAccueil);
	    
	    this.panelConnexionDirecteur.add(panelChamps);
	    ...
	    this.panelConnexionDirecteur.add(panelBouton, BorderLayout.SOUTH);
	    ...
	    this.getRootPane().setDefaultButton(boutonConnexion);
  		...
  		this.getContentPane().add(panelConnexionDirecteur);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == boutonConnexion) {
			...
			if(Modele.connexionDirecteur(login, mdp)) {
				this.panelMessageAccueil.remove(lblAccueil);
				this.dispose();
				AccueilDirecteur monAccueilDirecteur = new AccueilDirecteur();
			}
