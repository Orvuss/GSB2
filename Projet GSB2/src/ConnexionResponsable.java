...
/**
 * Classe ConnexionResponsable
 * @author ldatchi
 *
 */
public class ConnexionResponsable extends JFrame implements ActionListener{
	
	/**
	 * Attributs privés de la classe ConnexionResponsable
	 */
	//Attributs privés
	//Panel
	private JPanel panelConnexionResponsable;
	...
	public ConnexionResponsable() {
		 ...
		 */
	    this.setTitle("Connexion responsable");
	    ...
	    /**
	     * Instanciation de mes panels "panelConnexionResponsable", "panelMessageAccueil", "panelChamps" et "panelBouton"
	     */
	    //Instanciation des panels
	    this.panelConnexionResponsable = new JPanel();
	    this.panelMessageAccueil = new JPanel();
	    this.panelChamps = new JPanel();
	    this.panelBouton = new JPanel();
	    
	    /**
	     * Mise en place des background des panels "panelConnexionResponsable", "panelMessageAccueil" et "panelBouton"
	     */
	    //Disposition des panels
	    this.panelConnexionResponsable.setLayout(new BorderLayout());
	    ...
	    this.panelConnexionResponsable.add(panelMessageAccueil, BorderLayout.PAGE_START);
	    this.panelMessageAccueil.add(lblAccueil);
	    
	    this.panelConnexionResponsable.add(panelChamps);
	    ...
	    this.panelConnexionResponsable.add(panelBouton, BorderLayout.SOUTH);
	    ...
	    this.getRootPane().setDefaultButton(boutonConnexion);
  		...
  		this.getContentPane().add(panelConnexionResponsable);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == boutonConnexion) {
			...
			if(Modele.connexionResponsable(login, mdp)) {
				this.panelMessageAccueil.remove(lblAccueil);
				this.dispose();
				AccueilResponsable monAccueilResponsable = new AccueilResponsable();
			}
